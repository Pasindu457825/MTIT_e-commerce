...
from app.core.indexes import ensure_user_indexes
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # Idempotent index creation (unique email for users).
        await ensure_user_indexes(app.state.mongodb)
    except Exception:
...
def create_app() -> FastAPI:
    ...
    # Versioned API (e.g. `/api/v1/users`).
