...
from app.core.indexes import ensure_product_indexes
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # Idempotent index creation (list queries: category, price, created_at).
        await ensure_product_indexes(app.state.mongodb)
    except Exception:
...
def create_app() -> FastAPI:
    ...
    # Versioned API (e.g. `/api/v1/products`).
