...
from app.core.indexes import ensure_cart_indexes
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # Idempotent index creation (unique user_id on carts).
        await ensure_cart_indexes(app.state.mongodb)
    except Exception:
...
def create_app() -> FastAPI:
    ...
    # Versioned API (e.g. `/api/v1/cart/{user_id}`).
